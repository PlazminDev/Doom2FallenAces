...
void main()
{
    ...
    /// </summary>
    public void Update(GameWindow wnd, float deltaSeconds, out bool inputConsumed)
    {
        if (_frameBegun)
        {
            ImGui.Render();
        ...
        UpdateImGuiInput(wnd, out inputConsumed);
    ...
    private void UpdateImGuiInput(GameWindow wnd, out bool inputConsumed)
    {
        ImGuiIOPtr io = ImGui.GetIO();

        inputConsumed = io.WantCaptureMouse || io.WantCaptureKeyboard;
